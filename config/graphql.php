...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                'GithubProjectsQuery' => App\GraphQL\Queries\GithubProject\GithubProjectsQuery::class,
            ],
            'mutation' => [
                'CreateGithubProject' => App\GraphQL\Mutations\GithubProject\CreateGithubProjectMutation::class,
            ],
            // The types only available in this schema
            'types' => [
                //'GithubProjectsType' => App\GraphQL\Types\GithubProjectsType::class,
            ],
    ...
    //
    'types' => [
        //App\GraphQL\Types\GithubProjectsType::class,
        // ExampleType::class,
